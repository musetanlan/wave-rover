...
void baseInfoFeedback() {
	...
	// 导航PID状态信息（从nav_pid_ctrl获取）
	jsonInfoHttp["nav_active"] = nav_target_active;
	jsonInfoHttp["nav_reached"] = nav_goal_reached;
	jsonInfoHttp["nav_cx"] = nav_current_x;
	jsonInfoHttp["nav_cy"] = nav_current_y;
