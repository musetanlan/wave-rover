        ...
        <section>
            ...
            <div class="fb-input-info">
                ...
                <div class="info-box" style="padding:20px;">
                    <h2 class="h2-tt" style="font-size:1.2em;margin:0 0 12px 0;">NAVIGATION PID CONTROL</h2>
                    <div class="feedb-p" style="flex-wrap:wrap;gap:8px;">
                        <label style="color:rgba(255,255,255,0.7);">目标X(m):</label>
                        <input type="number" id="navTargetX" placeholder="X (m)" step="0.01" value="1.0" style="width:80px;height:36px;background:rgba(0,0,0,0.2);border:1px solid rgba(255,255,255,0.2);border-radius:4px;color:#fff;text-align:center;">
                        <label style="color:rgba(255,255,255,0.7);">目标Y(m):</label>
                        <input type="number" id="navTargetY" placeholder="Y (m)" step="0.01" value="0.0" style="width:80px;height:36px;background:rgba(0,0,0,0.2);border:1px solid rgba(255,255,255,0.2);border-radius:4px;color:#fff;text-align:center;">
                        <button class="small-btn" onclick="navSetTarget();" style="background-color:#2698EA;">GO</button>
                        <button class="small-btn" onclick="navStop();">STOP</button>
                    ...
                    <div class="json-cmd-info" style="margin-top:8px;">
                        <div><p>目标:{"T":700,"x":1,"y":0}</p><button class="w-btn" onclick="cmdFill('jsonData','navCmd700');">INPUT</button><span id="navCmd700" style="display:none;">{"T":700,"x":1.0,"y":0.0}</span></div>
                        <div><p>停止:{"T":702}</p><button class="w-btn" onclick="cmdFill('jsonData','navCmd702');">INPUT</button><span id="navCmd702" style="display:none;">{"T":702}</span></div>
                        <div><p>状态:{"T":707}</p><button class="w-btn" onclick="navGetStatus();">查询</button></div>
                        <div><p>归零:{"T":704}</p><button class="w-btn" onclick="cmdFill('jsonData','navCmd704');">INPUT</button><span id="navCmd704" style="display:none;">{"T":704}</span></div>
                    </div>
                </div>
            </div>
        </section>
