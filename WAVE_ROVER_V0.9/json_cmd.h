...
// 设置目标坐标，启动PID导航
// {"T":700,"x":1.5,"y":2.0}
#define CMD_NAV_SET_TARGET 700

// 更新当前位置（每0.1秒由外部调用）
// {"T":701,"x":1.5,"y":2.0,"h":0.78}
#define CMD_NAV_UPDATE_POS 701

// 停止导航
// {"T":702}
#define CMD_NAV_STOP 702

// 在线调整导航PID参数
// {"T":703,"kp_d":150,"ki_d":30,"kd_d":0,"kp_h":80,"ki_h":10,"kd_h":0}
#define CMD_NAV_SET_PID 703

// 重置里程计（将当前位置清零）
// {"T":704}
#define CMD_NAV_ODOMETRY_RESET 704

// 开关自动里程计
// {"T":705,"cmd":1}  cmd:1=开启, 0=关闭(使用手动位置更新)
#define CMD_NAV_AUTO_ODOMETRY 705

// 设置导航最大速度
// {"T":706,"spd":0.5}  spd范围: 0.0~1.0 m/s
#define CMD_NAV_SET_MAX_SPEED 706

// 获取导航状态信息
// {"T":707}
#define CMD_NAV_GET_STATUS 707